package com.example.ss19.config;
...
@ComponentScan(basePackages = "com.example.ss19")
public class WebConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.example.ss19.entity"); // Đường dẫn đến các entity
    ...
    public SessionFactory sessionFactory() {
        ...
        factoryBean.setPackagesToScan("com.example.ss19.entity");
